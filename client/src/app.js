						...
						<li className={cx(styles['bg-light-gray'], 'pa1')}>
							<section className={cx('row', 'middle-xs', 'items-center', 'justify-between')}>
								...
								<div className={cx('col-xs-12', 'col-sm-1', 'middle-xs', 'end-xs', 'flex1')}>
									<a className={cx('flex1')} href="https://twitter.com/jbrodriguezio" title="@jbrodriguezio" target="_blank"><i className={cx('f3', 'dark-green', 'fa fa-twitter')} /></a>
									<a className={cx('flex1', 'ml2')} href="https://github.com/jbrodriguez" title="github.com/jbrodriguez" target="_blank"><i className={cx('f3', 'dark-green', 'fa fa-github')} /></a>
									<img src={vm} />
								</div>
							</section>
						...
						<div className={cx('row', 'middle-xs', 'end-xs')}>
							<div className={cx('col-xs-12', 'middle-xs')}>
								<div className={cx('flex', 'end-xs')}>
									<a className={cx('flex', 'middle-xs')} href='https://itunes.apple.com/us/app/controlr/id1152586217?ls=1&mt=8'><img alt='Download on the App Store' src={apple} /></a>
									<a className={cx('flex', 'middle-xs', 'ml2')} href='http://play.google.com/store/apps/details?id=io.jbrodriguez.controlr&utm_source=global_co&utm_medium=prtnr&utm_content=Mar2515&utm_campaign=PartBadge&pcampaignid=MKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1'><img alt='Get it on Google Play' src={google} /></a>
									<a className={cx('flex', 'middle-xs', 'ml2')} href="http://lime-technology.com/" title="Lime Technology" target="_blank"><img src={unraid} alt="Logo for unRAID" /></a>
									<a className={cx('flex', 'middle-xs', 'ml2')} href="http://jbrodriguez.io/" title="jbrodriguez.io" target="_blank"><img src={logo} alt="Logo for Juan B. Rodriguez" /></a>
								</div>
							</div>
						</div>
					</ul>
